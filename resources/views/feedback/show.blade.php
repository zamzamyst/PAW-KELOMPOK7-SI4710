        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                ...
                <div class="mb-6">
                    ...
                    <textarea class="form-input w-full bg-gray-100 border border-gray-300 rounded px-3 py-2" rows="4" readonly>{{ $feedback->comment }}</textarea>
                </div>

                <div class="flex justify-end space-x-2">
                    <a href="{{ route('feedback.edit', $feedback->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-4 py-2 rounded">
                        Edit
                    </a>
                    <a href="{{ route('feedback.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-semibold px-4 py-2 rounded">
                        Back
                    </a>
                </div>
